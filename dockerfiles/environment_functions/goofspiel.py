"""Thin wrapper: goofspiel PvP rollout delegates to the shared multi-env module.

The trainer resolves rollout_func as 'goofspiel.rollout_first_prompt_and_completion'
and reward as 'goofspiel.rollout_reward_func' (text_trainer.py). Both come from
...
rollout_first_prompt_and_completion = make_rollout("goofspiel")
