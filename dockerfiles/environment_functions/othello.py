"""Thin wrapper: othello PvP rollout delegates to the shared multi-env module.

The trainer resolves rollout_func as 'othello.rollout_first_prompt_and_completion'
and reward as 'othello.rollout_reward_func' (text_trainer.py). Both come from
...
rollout_first_prompt_and_completion = make_rollout("othello")
